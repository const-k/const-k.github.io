...
module.exports = ({
  ...
  visit(markdownAST, `code`, node => {
    ...
    node.value = `` + `<div class="${highlightClassName}" data-language="${languageName}">` + `<pre${numLinesStyle} class="${className}${numLinesClass}">` + `<code class="${className}">` + `${highlightCode(language, node.value, highlightLines)}` + `</code>` + `${numLinesNumber}` + `</pre>` + `</div>`;
  });
